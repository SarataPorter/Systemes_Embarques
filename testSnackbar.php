...
<!-- Contenu de la page d'accueil -->
    ...
    <div id="Login" class="form" style="display:none;">
      ...
      <form action="<?php require "php/SignIn.php" ?>" method="POST" style="border: none !important;" >
      </br> Se connecter :  </br>  
      <table>
  ...
  <div id="Signin" class="form" style="display:none;">
    ...
    <input onclick="myFunction()" id="submit" type="submit" name="submit" value="Inscription" style="color: black"/><br/><br/>
